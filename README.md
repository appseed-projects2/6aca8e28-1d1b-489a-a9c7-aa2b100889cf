...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-11 19:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6aca8e28-1d1b-489a-a9c7-aa2b100889cf.git
$ cd 6aca8e28-1d1b-489a-a9c7-aa2b100889cf
```
